...
fileListNormal = [
			   	   '''
  			   	   'ChargedHiggs_HplusTB_HplusToTB_M-180_13TeV_amcatnlo_pythia8_hadd.root',
...
#                   'TT_TuneCUETP8M1_13TeV-powheg-pythia8_Mtt0to1000_hadd.root',
	           ...
	           'TT_TuneCUETP8M1_13TeV-powheg-pythia8_Mtt700to1000_hadd.root',
                   ...
                   '''
                   'TT_TuneCUETP8M1_13TeV-powheg-scaledown-pythia8_hadd.root',
                   'TT_TuneCUETP8M1_13TeV-powheg-scaleup-pythia8_hadd.root'
                ]
...
inputDir = '/user_data/jlee/chargedHiggs/LJMet_1lep_111816_step2preSel_aveBBdr_fixed/Test/nominal/'
